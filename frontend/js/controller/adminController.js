...
export async function initPosts(options = {}) {
  ...
  try {
    ...
    posts = await postService.getAllPosts(params); adminView.render(posts, handleDeletePost);
  } catch (error) {
...
export async function initEvents(options = {}) {
  ...
  try {
    ...
    events = await eventService.getAllEvents(params);
...
export async function initUsers(options = {}) {
  ...
  try {
    ...
    users = await userService.getAllUsers(buildingId);
